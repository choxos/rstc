...
# Load all ML STC functions
tryCatch({
  source("../advanced_methods/ML_STC/utils/ml_stc_utils.R")
  source("../advanced_methods/ML_STC/tree_based/causal_forests_stc.R")
  source("../advanced_methods/ML_STC/tree_based/bart_stc.R")
  source("../advanced_methods/ML_STC/tree_based/xgboost_stc.R")
  source("../advanced_methods/ML_STC/meta_learning/meta_learners_stc.R")
  source("../advanced_methods/ML_STC/meta_learning/double_ml_stc.R")
  source("../advanced_methods/ML_STC/specialized_causal/tmle_stc.R")
  source("../advanced_methods/ML_STC/ensemble_methods/aipw_stc.R")
  cat("✅ All ML-STC functions loaded successfully\n")
}, error = function(e) {
  cat("⚠️ Some functions may not be available:", e$message, "\n")
  cat("This vignette will demonstrate available methods only.\n")
})
```
