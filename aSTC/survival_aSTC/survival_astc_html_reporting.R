################################################################################
##################### Survival aSTC HTML Reporting Functions ##################
################################################################################
# 
# This module provides HTML reporting capabilities for survival anchored STC 
# analysis results, following the same professional TEM theme as unanchored STC
# and binary STC analyses.
#
# Main Functions:
...
#
# NOTE: Analysis functions (survival aSTC modeling, etc.) are imported from survival_astc_analysis.R
#
# Author: Survival Anchored STC Analysis Package  
# Version: 1.0
# Last Updated: 2024
# Theme: TEM Professional Styling (Purple Gradient)
################################################################################
...
generate_survival_astc_css <- function() {
...
generate_survival_astc_javascript <- function() {
...
#' 
#' @param results Results object from survival_astc_analysis()
...
#' 
#' @param results Analysis results from survival_astc_analysis()
...
#' @export
generate_survival_astc_html_report <- function(results, 
                                             project_name = "Clinical_Study",
                                             output_dir = "reports",
                                             output_file = NULL,
                                             title = "Survival Anchored STC Analysis Report",
                                             verbose = TRUE) {
  ...
  html_content <- generate_survival_astc_complete_html(results, title)
...
generate_survival_astc_complete_html <- function(results, title) {
...
<head>
    ...
    ', generate_survival_astc_css(), '
    ', generate_survival_astc_javascript(), '
</head>
<body>
    <div class="container">
        <!-- Header Section -->
        <div class="header">
            <h1>Survival Anchored STC Analysis</h1>
...
generate_survival_astc_results_tab <- function(results) {
...
generate_survival_astc_footer <- function() {
            ...
            <div class="footer-content">
                ...
                <div class="footer-company">
                    ...
                    <div class="footer-team">
                        Anchored STC Analysis Package | Survival STC Module
                    </div>
                </div>
